\section{Curriculum vitae (weight: 40\%)}\label{sec:cv}

\newrefsection[{output.bib}]
\newrefcontext[labelprefix={ko},sorting=ydnt]

\subsection{Academic profile}\label{sec:profile}
%\emph{Provide a comprehensive narrative of your academic achievements, research focus, research agenda, position in your (inter)national academic field, motivation, and the academic and societal potential of your work.}\\
